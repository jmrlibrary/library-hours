...
--
-- Host: localhost:3306
-- Generation Time: May 13, 2020 at 01:52 PM
...
--
ALTER TABLE `Schedule`
  MODIFY `SchedID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=267;
...
--
ALTER TABLE `Semesters`
  MODIFY `SemID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `Special`
--
ALTER TABLE `Special`
  MODIFY `SpecialID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
COMMIT;
